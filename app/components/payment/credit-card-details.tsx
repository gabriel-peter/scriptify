import { AddCreditCardModal } from "@/app/get-started/patient/payment/page"
import { useState } from "react"

export default function SavedCreditCard() {
    const [open, setOpen] = useState(false)
  
    return (
      <>
        <AddCreditCardModal open={open} setOpen={setOpen} />
